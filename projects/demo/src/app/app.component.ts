...
import { NgxAppVersionEventTruncate } from 'projects/ngx-app-version/src/lib';
...
export class AppComponent implements OnInit {
  ...
  public text = TEXT;
  public truncateEvent: NgxAppVersionEventTruncate;
    ...
    simple: [
      {
        ...
        code: '<p ngxAppVersion>{{ text }}</p>',
        description: 'Default number of lines (1) are truncated.'
      },
      {
        title: 'As innerHTML',
        code: '<p ngxAppVersion [innerHTML]="text"></p>',
        description: 'Default number of lines (1) are truncated.'
      }
    ],
    multiline: [
    ...
    disabled: [
      {
        ...
        code: '<p ngxAppVersion [size]="4" [truncateDisabled]="true">{{ text }}</p>',
    ...
    change: [
      {
        ...
        code: '<p ngxAppVersion [size]="2" (truncateChange)="truncateEvent = $event">{{ text }}</p>\n<pre>{{ truncateEvent | json }}</pre>',
    ...
    responsive: [
      {
        ...
        code: '<p ngxAppVersion size="xs">{{ text }}</p>',
        description:
      ...
      },
      {
        ...
        code: '<p ngxAppVersion size="sm">{{ text }}</p>',
        description:
      ...
      },
      {
        ...
        code: '<p ngxAppVersion size="md">{{ text }}</p>',
        description:
      ...
      },
      {
        ...
        code: '<p ngxAppVersion size="lg">{{ text }}</p>',
        description:
      ...
      },
      {
        ...
        code: '<p ngxAppVersion size="xl">{{ text }}</p>',
        description:
  ...
  public ngOnInit(): void {
    this.windowSize = `Window size is <strong>${window.innerWidth
